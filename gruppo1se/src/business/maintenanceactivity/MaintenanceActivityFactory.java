...
public abstract class MaintenanceActivityFactory {
    ...
    /**
     * Static method that creates and returns a Maintenance Activity object
     * according to the value of parameter type
     *
    ...
    /**
     * ** This method build the correct maintenance activity based on typology
     * parameter
     *
     * @param type typology of MaintenanceActivity
     * @param activityId Id of MaintenanceActivity that needs to be instantiate
    ...
    /**
     ** This method returns the correct instance of maintenance activity based
     * on factory class that extends MaintenanceActivityFactory and implements
     ...
     * @param activityDescription description of maintenance activity to
     * instantiate
     * @param estimatedInterventionTime estimatedIntervention time of
     * maintenance activity to instantiate
     * @param date date of maintenance activity to instantiate
     * @param maintenanceProcedure procedure of maintenance activity to
     * instantiate
     * @param materials required materials for maintenance to instantiate
     * @param interruptibleActivity indicates whether the activity is
     * interruptible to instantiate
