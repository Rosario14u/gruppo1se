...
public abstract class UnplannedMaintenanceActivity extends MaintenanceActivity{
    ...
    public UnplannedMaintenanceActivity(int activityId, Site site, String typology, String activityDescription, int estimatedInterventionTime, LocalDate date, MaintenanceProcedure maintenanceProcedure, List<Material> materials, List<Skill> skills, boolean interruptibleActivity) {
